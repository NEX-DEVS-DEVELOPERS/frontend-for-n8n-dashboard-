...
const SupportPage: React.FC<SupportPageProps> = ({ onOpenChatbot, onAddSupportRequest, requestCount, requestLimit, nextSupportTicketExpiresAt }) => {
    ...
    return (
        <>
            ...
            <div className="w-full max-w-5xl mx-auto animate-fade-in space-y-10 pb-12">
                <header className="text-center space-y-4 py-8">
                    <div className="inline-flex justify-center items-center p-4 bg-primary/10 rounded-full mb-2 border border-primary/20 shadow-[0_0_20px_rgba(72,168,163,0.2)]">
                        <QuestionMarkCircleIcon className="h-14 w-14 text-primary" />
                    </div>
                    <h1 className="text-5xl font-bold tracking-wide text-foreground drop-shadow-lg">Support & Assistance</h1>
                ...
                <Card className="text-center border-border/60 bg-card shadow-lg">
                    <CardContent className="p-10 pt-10 space-y-6">
                        <h3 className="font-bold text-3xl text-foreground">Contact Support</h3>
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold rounded-xl transition-all bg-primary hover:bg-n8n-dark text-primary-foreground shadow-lg shadow-primary/20 hover:scale-105 active:scale-95"
                        >
                ...
                <div className="space-y-6">
                    <h3 className="font-bold text-3xl text-foreground text-center pb-4">Frequently Asked Questions</h3>
